  ...
  <FooterSection>
    ...
    <div className="column two">
      <div className="group">
        ...
        <a
          className="link"
          href={`${absoluteLinks ? "https://www.prisma.io" : ""}/studio`}
        >
          Prisma Studio
        </a>
      ...
      <div className="group">
        ...
        <a
          className="link"
          href={`${absoluteLinks ? "https://www.prisma.io" : ""}/nextjs`}
        >
          Prisma with Next.js
        </a>
        <a
        ...
        <a
          className="link"
          href={`${absoluteLinks ? "https://www.prisma.io" : ""}/apollo`}
        >
          Prisma with Apollo
        </a>
        <a
          className="link"
          href={`${absoluteLinks ? "https://www.prisma.io" : ""}/nestjs`}
        >
          Prisma with NestJS
        </a>
        <a
          className="link"
          href={`${absoluteLinks ? "https://www.prisma.io" : ""}/express`}
        >
          Prisma with Express
        </a>
        <a
          className="link"
          href={`${absoluteLinks ? "https://www.prisma.io" : ""}/hapi`}
        >
          Prisma with hapi
        </a>
      </div>
    ...
    <div className="column three">
      <div className="group">
        ...
        <a
          className="link"
          href={`${absoluteLinks ? "https://www.prisma.io" : ""}/ambassador`}
        >
          Prisma Ambassador
        </a>
        <a
      ...
      <div className="group">
        ...
        <a
          className="link"
          href={`${absoluteLinks ? "https://www.prisma.io" : ""}/sitemap`}
        >
          HTML Sitemap
        </a>
      </div>
    ...
    <div className="column four">
      ...
      <div className="group">
        ...
        <p className="copyright">Prisma © 2018-{new Date().getFullYear()}.</p>
