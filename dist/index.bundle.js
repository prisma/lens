...
`;t.default=r},function(e,t,a){"use strict";var r=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0});const l=r(a(0)),o=r(a(1)),i=l.default.p`
  font-weight: bold;
  font-family: ${o.default.fonts.display};
  font-size: ${o.default.fontSizes[20]};
  letter-spacing: 0.1em;
  text-transform: uppercase;
  margin-bottom: ${o.default.space[16]};
  color: ${o.default.colors.gray500};
`;t.default=i},function(e,t,a){"use strict";var r=this&&this.__createBinding||(Object.create?function(e,t,a,r){void 0===r&&(r=a),Object.defineProperty(e,r,{enumerable:!0,get:function(){return t[a]}})}:function(e,t,a,r){void 0===r&&(r=a),e[r]=t[a]}),l=this&&this.__setModuleDefault||(Object.create?function(e,t){Object.defineProperty(e,"default",{enumerable:!0,value:t})}:function(e,t){e.default=t}),o=this&&this.__importStar||function(e){if(e&&e.__esModule)return e;var t={};if(null!=e)for(var a in e)"default"!==a&&Object.prototype.hasOwnProperty.call(e,a)&&r(t,e,a);return l(t,e),t},i=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0});const n=o(a(2)),s=i(a(1)),f=i(a(0)),c=f.default.div`
...
`,u=()=>n.default.createElement(c,null,n.default.createElement("a",{href:"https://www.prisma.io/docs/getting-started/quickstart-typescript"},"Quickstart"),n.default.createElement("a",{href:"https://www.prisma.io/docs/"},"Docs"),n.default.createElement("a",{href:"https://www.prisma.io/docs/about/faq"},"FAQ"),n.default.createElement("a",{href:"https://www.prisma.io/community"},"Community"),n.default.createElement("a",{href:"https://www.prisma.io/blog/"},"Blog"),n.default.createElement("a",{href:"https://github.com/prisma",className:"github"},"GitHub")),d=f.default.nav`
  position: relative;
  display: none;
...
`;class m extends n.Component{constructor(e){super(e),this.state={open:!1},this.toggle=()=>{this.setState({open:!this.state.open})},this.maybeClose=e=>{const t=e.target;this.state.open&&t instanceof HTMLElement&&(this.nav.current&&this.nav.current.contains(t)||this.setState({open:!1}))},this.nav=n.createRef()}componentDidMount(){"undefined"!=typeof window&&window.addEventListener("click",this.maybeClose)}componentWillUnmount(){"undefined"!=typeof window&&window.removeEventListener("click",this.maybeClose)}render(){return n.default.createElement(d,{ref:this.nav},n.default.createElement("button",{className:"menu",onClick:this.toggle},"menu"),n.default.createElement("div",{className:"list","data-open":this.state.open},n.default.createElement(u,null)))}}const p=f.default.nav`
  margin: 0 auto;
  max-width: 1200px;
  width: 100%;
  display: flex;
